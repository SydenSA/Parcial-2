namespace Autores.Views
{
    partial class frm_Prestamo
    {
        ...
        {
            lst_Prestamo = new ListBox();
            label3 = new Label();
            Lista = new Label();
            label1 = new Label();
            txt_Detalle_Prestamo = new TextBox();
            ...
            // lst_Prestamo
            // 
            lst_Prestamo.FormattingEnabled = true;
            lst_Prestamo.ItemHeight = 15;
            lst_Prestamo.Location = new Point(411, 87);
            lst_Prestamo.Name = "lst_Prestamo";
            lst_Prestamo.Size = new Size(209, 184);
            lst_Prestamo.TabIndex = 29;
            lst_Prestamo.SelectedIndexChanged += lst_Prestamo_SelectedIndexChanged;
            // 
            // label3
            // 
            ...
            Lista.Name = "Lista";
            Lista.Size = new Size(84, 15);
            Lista.TabIndex = 27;
            Lista.Text = "Lista Prestamo";
            // 
            // label1
            // 
            ...
            label1.TabIndex = 26;
            label1.Text = "Datos Prestamo";
            // 
            // txt_Detalle_Prestamo
            // 
            txt_Detalle_Prestamo.Location = new Point(200, 165);
            txt_Detalle_Prestamo.Name = "txt_Detalle_Prestamo";
            txt_Detalle_Prestamo.Size = new Size(167, 23);
            txt_Detalle_Prestamo.TabIndex = 25;
            txt_Detalle_Prestamo.TextChanged += txt_Detalle_Prestamo_TextChanged;
            // 
            // btn_Salir
            // 
            ...
            Controls.Add(lst_Prestamo);
            Controls.Add(label3);
            Controls.Add(Lista);
            Controls.Add(label1);
            Controls.Add(txt_Detalle_Prestamo);
        ...
        private ListBox lst_Prestamo;
        private Label label3;
        private Label Lista;
        private Label label1;
        private TextBox txt_Detalle_Prestamo;
